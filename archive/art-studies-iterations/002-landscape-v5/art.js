// ============================================================================
// V5 MOUNTAIN LANDSCAPE - ART FUNDAMENTALS APPLIED
// ============================================================================
// NEW TECHNIQUES vs V4:
// 1. 5-Value System on all forms (highlight→light→halftone→core shadow→reflected light)
// 2. Form shadows with proper halftone transitions (NOT hard edges)
// 3. Cast shadows: hard at contact, soft at distance
// 4. Compositing operations: 'multiply' for shadows, 'lighter' for glows
// 5. Atmospheric perspective via COLOR SHIFT + desaturation (not just alpha)
// 6. ColorUtils for programmatic color manipulation
// ============================================================================
